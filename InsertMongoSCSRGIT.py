# This is the MODIFIED GENERAL PROGRAM FOR RGIT ONLY data

#Note, the directory or os.path is different in this and html files are RGIT files ONLY 
#Also, the mongoDB collection in this is CHANGED to RGIT..

#So, this program will execute ONLY for RGIT Data 
...
if __name__=="__main__":
	...
	for file in os.listdir("C:/users/Admin/Desktop/PythonCode/SCSHTML/SCSRGIT"):
