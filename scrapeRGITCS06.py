...
os.chdir("C:\Users\Admin\Desktop\PythonCode\CS6HTML\RGIT")
...
for a,b in zip(collegeno,maxrollno):
    for i in range(101,107):  #replaced int(b)+1 with 101
        usn= (a+'12cs'+"%03d"%i).upper()  #changed here as per format 
        print (usn)
        count +=1
        #time.sleep(5)  
