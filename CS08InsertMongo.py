#Code modified for 8th semester on 07/09/2015
...
def process_file_updatedb(fname):
	...
	if (boldlen>2):
		...
		if int(semesternum[-1]) != 8:  # THIS CHECK HAS TO BE MODIFIED for each semester 
	...
	if (blank==0):
		...
		if (sizeOfVlist >2):
			...
			if '10IS81' in valueList[2][0]:
				sub1="10IS811"
				found +=1
			elif '10CS82' in valueList[2][0]:
				sub1="10CS82"
				found +=1
			elif '10CS85' in valueList[2][0]:
				sub1="10CS85"
				found +=1
			elif '10CS86' in valueList[2][0]:
				sub1="10CS86"
				found +=1
			elif '10CS831' in valueList[2][0]:
				sub1="10CS831"
				found +=1
			elif '10CS832' in valueList[2][0]:
				sub1="10CS832"
				found +=1
			elif '10CS833' in valueList[2][0]:
				sub1="10CS833"
				found +=1
			elif '10CS834' in valueList[2][0]:
				sub1="10CS834"
				found +=1
			elif '10CS835' in valueList[2][0]:
				sub1="10CS835"
				found +=1
			elif '10CS836' in valueList[2][0]:
				sub1="10CS836"
				found +=1
			elif '10CS841' in valueList[2][0]:
				sub1="10CS841"
				found +=1
			elif '10CS842' in valueList[2][0]:
				sub1="10CS842"
				found +=1
			elif '10CS843' in valueList[2][0]:
				sub1="10CS843"
				found +=1
			elif '10CS844' in valueList[2][0]:
				sub1="10CS844"
				found +=1	
			elif '10CS845' in valueList[2][0]:
				sub1="10CS845"
				found +=1
			elif '10CS846' in valueList[2][0]:
				sub1="10CS846"
				found +=1	
...
#for the 2nd subject 
		if (sizeOfVlist >3):
			...
			if '10IS81' in valueList[3][0]:
				sub2="10IS811"
				found +=1
			elif '10CS82' in valueList[3][0]:
				sub2="10CS82"
				found +=1
			elif '10CS85' in valueList[3][0]:
				sub2="10CS85"
				found +=1
			elif '10CS86' in valueList[3][0]:
				sub2="10CS86"
				found +=1
			elif '10CS831' in valueList[3][0]:
				sub2="10CS831"
				found +=1
			elif '10CS832' in valueList[3][0]:
				sub2="10CS832"
				found +=1
			elif '10CS833' in valueList[3][0]:
				sub2="10CS833"
				found +=1
			elif '10CS834' in valueList[3][0]:
				sub2="10CS834"
				found +=1
			elif '10CS835' in valueList[3][0]:
				sub2="10CS835"
				found +=1
			elif '10CS836' in valueList[3][0]:
				sub2="10CS836"
				found +=1
			elif '10CS841' in valueList[3][0]:
				sub2="10CS841"
				found +=1
			elif '10CS842' in valueList[3][0]:
				sub2="10CS842"
				found +=1
			elif '10CS843' in valueList[3][0]:
				sub2="10CS843"
				found +=1
			elif '10CS844' in valueList[3][0]:
				sub2="10CS844"
				found +=1	
			elif '10CS845' in valueList[3][0]:
				sub2="10CS845"
				found +=1
			elif '10CS846' in valueList[3][0]:
				sub2="10CS846"
				found +=1
...
#for the 3rd subject 
		if (sizeOfVlist >4):
			...
			if '10IS81' in valueList[4][0]:
				sub3="10IS811"
				found +=1
			elif '10CS82' in valueList[4][0]:
				sub3="10CS82"
				found +=1
			elif '10CS85' in valueList[4][0]:
				sub3="10CS85"
				found +=1
			elif '10CS86' in valueList[4][0]:
				sub3="10CS86"
				found +=1
			elif '10CS831' in valueList[4][0]:
				sub3="10CS831"
				found +=1
			elif '10CS832' in valueList[4][0]:
				sub3="10CS832"
				found +=1
			elif '10CS833' in valueList[4][0]:
				sub3="10CS833"
				found +=1
			elif '10CS834' in valueList[4][0]:
				sub3="10CS834"
				found +=1
			elif '10CS835' in valueList[4][0]:
				sub3="10CS835"
				found +=1
			elif '10CS836' in valueList[4][0]:
				sub3="10CS836"
				found +=1
			elif '10CS841' in valueList[4][0]:
				sub3="10CS841"
				found +=1
			elif '10CS842' in valueList[4][0]:
				sub3="10CS842"
				found +=1
			elif '10CS843' in valueList[4][0]:
				sub3="10CS843"
				found +=1
			elif '10CS844' in valueList[4][0]:
				sub3="10CS844"
				found +=1	
			elif '10CS845' in valueList[4][0]:
				sub3="10CS845"
				found +=1
			elif '10CS846' in valueList[4][0]:
				sub3="10CS846"
				found +=1
...
#for the 4th subject 
		if (sizeOfVlist>5):
			...
			if '10IS81' in valueList[5][0]:
				sub4="10IS811"
				found +=1
			elif '10CS82' in valueList[5][0]:
				sub4="10CS82"
				found +=1
			elif '10CS85' in valueList[5][0]:
				sub4="10CS85"
				found +=1
			elif '10CS86' in valueList[5][0]:
				sub4="10CS86"
				found +=1
			elif '10CS831' in valueList[5][0]:
				sub4="10CS831"
				found +=1
			elif '10CS832' in valueList[5][0]:
				sub4="10CS832"
				found +=1
			elif '10CS833' in valueList[5][0]:
				sub4="10CS833"
				found +=1
			elif '10CS834' in valueList[5][0]:
				sub4="10CS834"
				found +=1
			elif '10CS835' in valueList[5][0]:
				sub4="10CS835"
				found +=1
			elif '10CS836' in valueList[5][0]:
				sub4="10CS836"
				found +=1
			elif '10CS841' in valueList[5][0]:
				sub4="10CS841"
				found +=1
			elif '10CS842' in valueList[5][0]:
				sub4="10CS842"
				found +=1
			elif '10CS843' in valueList[5][0]:
				sub4="10CS843"
				found +=1
			elif '10CS844' in valueList[5][0]:
				sub4="10CS844"
				found +=1	
			elif '10CS845' in valueList[5][0]:
				sub4="10CS845"
				found +=1
			elif '10CS846' in valueList[5][0]:
				sub4="10CS846"
				found +=1
...
#for the 5th subject 
		if (sizeOfVlist>6):
			...
			if '10IS81' in valueList[6][0]:
				sub5="10IS811"
				found +=1
			elif '10CS82' in valueList[6][0]:
				sub5="10CS82"
				found +=1
			elif '10CS85' in valueList[6][0]:
				sub5="10CS85"
				found +=1
			elif '10CS86' in valueList[6][0]:
				sub5="10CS86"
				found +=1
			elif '10CS831' in valueList[6][0]:
				sub5="10CS831"
				found +=1
			elif '10CS832' in valueList[6][0]:
				sub5="10CS832"
				found +=1
			elif '10CS833' in valueList[6][0]:
				sub5="10CS833"
				found +=1
			elif '10CS834' in valueList[6][0]:
				sub5="10CS834"
				found +=1
			elif '10CS835' in valueList[6][0]:
				sub5="10CS835"
				found +=1
			elif '10CS836' in valueList[6][0]:
				sub5="10CS836"
				found +=1
			elif '10CS841' in valueList[6][0]:
				sub5="10CS841"
				found +=1
			elif '10CS842' in valueList[6][0]:
				sub5="10CS842"
				found +=1
			elif '10CS843' in valueList[6][0]:
				sub5="10CS843"
				found +=1
			elif '10CS844' in valueList[6][0]:
				sub5="10CS844"
				found +=1	
			elif '10CS845' in valueList[6][0]:
				sub5="10CS845"
				found +=1
			elif '10CS846' in valueList[6][0]:
				sub5="10CS846"
				found +=1
...
#for the 6th subject 
		if (sizeOfVlist > 7):
			...
			if '10IS81' in valueList[7][0]:
				sub6="10IS811"
				found +=1
			elif '10CS82' in valueList[7][0]:
				sub6="10CS82"
				found +=1
			elif '10CS85' in valueList[7][0]:
				sub6="10CS85"
				found +=1
			elif '10CS86' in valueList[7][0]:
				sub6="10CS86"
				found +=1
			elif '10CS831' in valueList[7][0]:
				sub6="10CS831"
				found +=1
			elif '10CS832' in valueList[7][0]:
				sub6="10CS832"
				found +=1
			elif '10CS833' in valueList[7][0]:
				sub6="10CS833"
				found +=1
			elif '10CS834' in valueList[7][0]:
				sub6="10CS834"
				found +=1
			elif '10CS835' in valueList[7][0]:
				sub6="10CS835"
				found +=1
			elif '10CS836' in valueList[7][0]:
				sub6="10CS836"
				found +=1
			elif '10CS841' in valueList[7][0]:
				sub6="10CS841"
				found +=1
			elif '10CS842' in valueList[7][0]:
				sub6="10CS842"
				found +=1
			elif '10CS843' in valueList[7][0]:
				sub6="10CS843"
				found +=1
			elif '10CS844' in valueList[7][0]:
				sub6="10CS844"
				found +=1	
			elif '10CS845' in valueList[7][0]:
				sub6="10CS845"
				found +=1
			elif '10CS846' in valueList[7][0]:
				sub6="10CS846"
				found +=1
...
#for the 7th subject 
		if (sizeOfVlist >8):
			...
			if '10IS81' in valueList[8][0]:
				sub7="10IS811"
				found +=1
			elif '10CS82' in valueList[8][0]:
				sub7="10CS82"
				found +=1
			elif '10CS85' in valueList[8][0]:
				sub7="10CS85"
				found +=1
			elif '10CS86' in valueList[8][0]:
				sub7="10CS86"
				found +=1
			elif '10CS831' in valueList[8][0]:
				sub7="10CS831"
				found +=1
			elif '10CS832' in valueList[8][0]:
				sub7="10CS832"
				found +=1
			elif '10CS833' in valueList[8][0]:
				sub7="10CS833"
				found +=1
			elif '10CS834' in valueList[8][0]:
				sub7="10CS834"
				found +=1
			elif '10CS835' in valueList[8][0]:
				sub7="10CS835"
				found +=1
			elif '10CS836' in valueList[8][0]:
				sub7="10CS836"
				found +=1
			elif '10CS841' in valueList[8][0]:
				sub7="10CS841"
				found +=1
			elif '10CS842' in valueList[8][0]:
				sub7="10CS842"
				found +=1
			elif '10CS843' in valueList[8][0]:
				sub7="10CS843"
				found +=1
			elif '10CS844' in valueList[8][0]:
				sub7="10CS844"
				found +=1	
			elif '10CS845' in valueList[8][0]:
				sub7="10CS845"
				found +=1
			elif '10CS846' in valueList[8][0]:
				sub7="10CS846"
				found +=1				
...
#for the 8th subject 
		if (sizeOfVlist >9):
			...
			if '10IS81' in valueList[9][0]:
				sub8="10IS811"
				found +=1
			elif '10CS82' in valueList[9][0]:
				sub8="10CS82"
				found +=1
			elif '10CS85' in valueList[9][0]:
				sub8="10CS85"
				found +=1
			elif '10CS86' in valueList[9][0]:
				sub8="10CS86"
				found +=1
			elif '10CS831' in valueList[9][0]:
				sub8="10CS831"
				found +=1
			elif '10CS832' in valueList[9][0]:
				sub8="10CS832"
				found +=1
			elif '10CS833' in valueList[9][0]:
				sub8="10CS833"
				found +=1
			elif '10CS834' in valueList[9][0]:
				sub8="10CS834"
				found +=1
			elif '10CS835' in valueList[9][0]:
				sub8="10CS835"
				found +=1
			elif '10CS836' in valueList[9][0]:
				sub8="10CS836"
				found +=1
			elif '10CS841' in valueList[9][0]:
				sub8="10CS841"
				found +=1
			elif '10CS842' in valueList[9][0]:
				sub8="10CS842"
				found +=1
			elif '10CS843' in valueList[9][0]:
				sub8="10CS843"
				found +=1
			elif '10CS844' in valueList[9][0]:
				sub8="10CS844"
				found +=1	
			elif '10CS845' in valueList[9][0]:
				sub8="10CS845"
				found +=1
			elif '10CS846' in valueList[9][0]:
				sub8="10CS846"
				found +=1		
...
if __name__=="__main__":
	...
	for file in os.listdir("C:/users/Admin/Desktop/VTUresultanalysis/CS8HTML"):
