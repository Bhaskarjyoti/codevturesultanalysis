# this code is updated with a fix on 28/08 ( what will happen if the result has only <8 subjects ). To avoid that code brekage, we have to keep a counter 
...
def process_file_updatedb(fname):
	...
	if (boldlen>2):
		...
		if int(semesternum[-1]) != 4:  # THIS CHECK HAS TO BE MODIFIED for each semester 
	...
	if (blank==0):
		...
		if (sizeOfVlist >2):
			...
			if '10MAT41' in valueList[2][0]:
				sub1="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[2][0]:
				sub1="MATDIP401"
				found +=1
			elif '10CS42' in valueList[2][0]:
				sub1="10CS42"
				found +=1
			elif '10CS43' in valueList[2][0]:
				sub1="10CS43"
				found +=1
			elif '10CS44' in valueList[2][0]:
				sub1="10CS44"
				found +=1
			elif '10CS45' in valueList[2][0]:
				sub1="10CS45"
				found +=1
			elif '10CS46' in valueList[2][0]:
				sub1="10CS426"
				found +=1
			elif '10CSL47' in valueList[2][0]:
				sub1="10CSL47"
				found +=1
			elif '10CSL48' in valueList[2][0]:
				sub1="10CSL48"
				found +=1
	...
	#for the 2nd subject 
		if (sizeOfVlist >3):
			...
			if '10MAT41' in valueList[3][0]:
				sub2="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[3][0]:
				sub2="MATDIP401"
				found +=1				
			elif '10CS42' in valueList[3][0]:
				sub2="10CS42"
				found +=1
			elif '10CS43' in valueList[3][0]:
				sub2="10CS43"
				found +=1
			elif '10CS44' in valueList[3][0]:
				sub2="10CS44"
				found +=1
			elif '10CS45' in valueList[3][0]:
				sub2="10CS45"
				found +=1
			elif '10CS46' in valueList[3][0]:
				sub2="10CS426"
				found +=1
			elif '10CSL47' in valueList[3][0]:
				sub2="10CSL47"
				found +=1
			elif '10CSL48' in valueList[3][0]:
				sub2="10CSL48"
				found +=1
		...
		if (sizeOfVlist >4):
			...
			if '10MAT41' in valueList[4][0]:
				sub3="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[4][0]:
				sub3="MATDIP401"
				found +=1				
			elif '10CS42' in valueList[4][0]:
				sub3="10CS42"
				found +=1
			elif '10CS43' in valueList[4][0]:
				sub3="10CS43"
				found +=1
			elif '10CS44' in valueList[4][0]:
				sub3="10CS44"
				found +=1
			elif '10CS45' in valueList[4][0]:
				sub3="10CS45"
				found +=1
			elif '10CS46' in valueList[4][0]:
				sub3="10CS426"
				found +=1
			elif '10CSL47' in valueList[4][0]:
				sub3="10CSL47"
				found +=1
			elif '10CSL48' in valueList[4][0]:
				sub3="10CSL48"
				found +=1
...
#for the 4th subject 
		if (sizeOfVlist>5):
			...
			if '10MAT41' in valueList[5][0]:
				sub4="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[5][0]:
				sub4="MATDIP401"
				found +=1				
			elif '10CS42' in valueList[5][0]:
				sub4="10CS42"
				found +=1
			elif '10CS43' in valueList[5][0]:
				sub4="10CS43"
				found +=1
			elif '10CS44' in valueList[5][0]:
				sub4="10CS44"
				found +=1
			elif '10CS45' in valueList[5][0]:
				sub4="10CS45"
				found +=1
			elif '10CS46' in valueList[5][0]:
				sub4="10CS426"
				found +=1
			elif '10CSL47' in valueList[5][0]:
				sub4="10CSL47"
				found +=1
			elif '10CSL48' in valueList[5][0]:
				sub4="10CSL48"
				found +=1
...
#for the 5th subject 
		if (sizeOfVlist>6):
			...
			if '10MAT41' in valueList[6][0]:
				sub5="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[6][0]:
				sub5="MATDIP401"
				found +=1			
			elif '10CS42' in valueList[6][0]:
				sub5="10CS42"
				found +=1
			elif '10CS43' in valueList[6][0]:
				sub5="10CS43"
				found +=1
			elif '10CS44' in valueList[6][0]:
				sub5="10CS44"
				found +=1
			elif '10CS45' in valueList[6][0]:
				sub5="10CS45"
				found +=1
			elif '10CS46' in valueList[6][0]:
				sub5="10CS426"
				found +=1
			elif '10CSL47' in valueList[6][0]:
				sub5="10CSL47"
				found +=1
			elif '10CSL48' in valueList[6][0]:
				sub5="10CSL48"
				found +=1
...
#for the 6th subject 
		if (sizeOfVlist > 7):
			...
			if '10MAT41' in valueList[7][0]:
				sub6="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[7][0]:
				sub6="MATDIP401"
				found +=1			
			elif '10CS42' in valueList[7][0]:
				sub6="10CS42"
				found +=1
			elif '10CS43' in valueList[7][0]:
				sub6="10CS43"
				found +=1
			elif '10CS44' in valueList[7][0]:
				sub6="10CS44"
				found +=1
			elif '10CS45' in valueList[7][0]:
				sub6="10CS45"
				found +=1
			elif '10CS46' in valueList[7][0]:
				sub6="10CS426"
				found +=1
			elif '10CSL47' in valueList[7][0]:
				sub6="10CSL47"
				found +=1
			elif '10CSL48' in valueList[7][0]:
				sub6="10CSL48"
				found +=1
...
#for the 7th subject 
		if (sizeOfVlist >8):
			...
			if '10MAT41' in valueList[8][0]:
				sub7="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[8][0]:
				sub7="MATDIP401"
				found +=1			
			elif '10CS42' in valueList[8][0]:
				sub7="10CS42"
				found +=1
			elif '10CS43' in valueList[8][0]:
				sub7="10CS43"
				found +=1
			elif '10CS44' in valueList[8][0]:
				sub7="10CS44"
				found +=1
			elif '10CS45' in valueList[8][0]:
				sub7="10CS45"
				found +=1
			elif '10CS46' in valueList[8][0]:
				sub7="10CS426"
				found +=1
			elif '10CSL47' in valueList[8][0]:
				sub7="10CSL47"
				found +=1
			elif '10CSL48' in valueList[8][0]:
				sub7="10CSL48"
				found +=1
...
#for the 8th subject 
		if (sizeOfVlist >9):
			...
			if '10MAT41' in valueList[9][0]:
				sub8="10MAT41"
				found +=1
			elif 'MATDIP401' in valueList[9][0]:
				sub8="MATDIP401"
				found +=1				
			elif '10CS42' in valueList[9][0]:
				sub8="10CS42"
				found +=1
			elif '10CS43' in valueList[9][0]:
				sub8="10CS43"
				found +=1
			elif '10CS44' in valueList[9][0]:
				sub8="10CS44"
				found +=1
			elif '10CS45' in valueList[9][0]:
				sub8="10CS45"
				found +=1
			elif '10CS46' in valueList[9][0]:
				sub8="10CS426"
				found +=1
			elif '10CSL47' in valueList[9][0]:
				sub8="10CSL47"
				found +=1
			elif '10CSL48' in valueList[9][0]:
				sub8="10CSL48"
				found +=1
...
if __name__=="__main__":
	...
	for file in os.listdir("C:/users/Admin/Desktop/PythonCode/CS4HTML/RGIT"):
